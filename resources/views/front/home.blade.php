...
<div id="hero-section" data-number="3" data-image-1="{{ asset('assets/front/assets/img/slider/1.jpg') }}" data-image-2="{{ asset('assets/front/assets/img/slider/2.jpg') }}" data-image-3="{{ asset('assets/front/assets/img/slider/3.jpg') }}" data-effect="fade">
    <div class="hero-content">
        ...
        <div class="links">
            <a class="wprt-button big rounded-3px" href="page-about.html">LEARN MORE</a>
