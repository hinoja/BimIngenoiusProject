...
@push('css')
    <style>
        ...
        .share-btn-inline:nth-child(1) {
            animation-delay: 0.1s;
        }

        .share-btn-inline:nth-child(2) {
            animation-delay: 0.15s;
        }

        .share-btn-inline:nth-child(3) {
            animation-delay: 0.2s;
        }

        .share-btn-inline:nth-child(4) {
            animation-delay: 0.25s;
        }

        .share-btn-inline:nth-child(5) {
            animation-delay: 0.3s;
        }

        .share-btn-inline:nth-child(6) {
            animation-delay: 0.35s;
        }

        .share-btn-inline:nth-child(7) {
...
<div class="inline-share-container">
    ...
    <div class="share-buttons-inline">
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u={{ $url }}" target="_blank"
            rel="noopener noreferrer" class="share-btn-inline facebook-btn" data-tooltip="Facebook"
        ...
        <a href="https://twitter.com/intent/tweet?url={{ $url }}&text={{ urlencode($data->title) }}"
            target="_blank" rel="noopener noreferrer" class="share-btn-inline twitter-btn" data-tooltip="Twitter"
        ...
        <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ $url }}" target="_blank"
            rel="noopener noreferrer" class="share-btn-inline linkedin-btn" data-tooltip="LinkedIn"
            onclick="trackShareInline('linkedin')">
            <i class="fab fa-linkedin-in"></i>
        </a>

        <!-- WhatsApp -->
        <a href="https://wa.me/?text={{ urlencode($data->title . ' - ' . request()->fullUrl()) }}" target="_blank"
            rel="noopener noreferrer" class="share-btn-inline whatsapp-btn" data-tooltip="WhatsApp"
            onclick="trackShareInline('whatsapp')">
            <i class="fab fa-whatsapp"></i>
        </a>

        <!-- Telegram -->
        <a href="https://t.me/share/url?url={{ $url }}&text={{ urlencode($data->title) }}" target="_blank"
            rel="noopener noreferrer" class="share-btn-inline telegram-btn" data-tooltip="Telegram"
        ...
        <!-- Copy Link -->
        <button class="share-btn-inline copy-btn" data-tooltip="@lang('Copy Link')"
