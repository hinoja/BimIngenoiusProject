           ...
           <form class="comment-form">
               <div class="form-group @error('name') has-error @enderror has-feedback">
                   <input id="name" wire:model.defer="name" type="text"
                       class="form-control @error('name') is-invalid @enderror" placeholder="@lang('Your Name')">
                   @error('name')
               ...
               <div class="form-group @error('email') has-error @enderror has-feedback">
                   <input id="email" wire:model.defer="email" type="email"
                       class="form-control @error('email') is-invalid @enderror" placeholder="@lang('Your Email')">
                   @error('email')
                       <div class="invalid-feedback text-danger text-bold"><strong>{{ $message }}</strong></div>
                   @enderror
               </div>
               <div class="form-group @error('subject') has-error @enderror has-feedback">
                   <input id="subject" wire:model.defer="subject" type="text"
                       class="form-control @error('subject') is-invalid @enderror" placeholder="@lang('Your Subject')">
                   @error('subject')
                       <div class="invalid-feedback text-danger text-bold"><strong>{{ $message }}</strong></div>
                   @enderror
               </div>
               <div class="comment-form-comment form-group @error('message') has-error @enderror has-feedback">
                   <textarea id="message" wire:model.defer="message" placeholder="@lang('Your Message')"
               ...
               <div class="text-right">
                   <button wire:click.prevent="store" wire:loading.remove class="ot-btn btn-color"
